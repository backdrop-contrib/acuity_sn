...
Set options for :-
 ...
 - Machine name: A machine readable field name withthat must consist of lowercase letters, numbers and underscores but it must start with a character. i.e. "invoice_number", "po_number", "widget_serial".
 - Label: This is the human readable text and field label used on forms and when selecting the widge from the Content Type field settings.
